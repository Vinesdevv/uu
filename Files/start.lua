...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or "فينيس"
SudosS = {833156404}
Sudos = {sudoid,833156404}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '⌔ 𝘷𝘪𝘯𝘦𝘴 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/DevVines"}},
}
}
...
{{text = '⌔ قناه التحديثات .',url="t.me/DevVines"}},
{{text = '⌔ رجوع .',data="Can"}},
}
}
...
{{text = '⌔ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "فينيس"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/DevVines&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔︙الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "فينيس"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "فينيس"),"اني لقميل "..(redis:get(bot_id..":namebot") or "فينيس"),(redis:get(bot_id..":namebot") or "فينيس").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end 
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "فينيس") then
...
local UserId_Info = bot.searchPublicChat("NNUUU")
if UserId_Info.id then
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '⌔ 𝘷𝘪𝘯𝘦𝘴 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/DevVines"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
return send("sendphoto",{
chat_id=msg.chat_id,
photo="https://t.me/DevVines",
caption=('*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝘷𝘪𝘯𝘦𝘴 .\n\n*[⌔  𝘷𝘪𝘯𝘦𝘴 𝘤𝘩𝘢𝘯𝘯𝘦𝘭 .](http://t.me/DevVines)*\n\n*[⌔  𝘪𝘯𝘧𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 .](http://t.me/Dev_Vines)*\n\n*[⌔  𝘷𝘪𝘯𝘦𝘴 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .](http://t.me/NNUUU)*\n\n*[⌔  𝘣𝘰𝘵 𝘷𝘪𝘯𝘦𝘴 .](http://t.me/S_H_Wbot)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '⌔  𝘷𝘪𝘯𝘦𝘴 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/DevVines"}}})
})
